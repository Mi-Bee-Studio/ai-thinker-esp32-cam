...
{
    return config_get()->cam_fps;   /* 契约 §3.1 cam_fps 消费者（旧 GetProfiles 同源） */
}

esp_err_t onvif_port_start(void)
{
    /* 运行时开关（原 main.c Step 门：config onvif_enable，本板默认 1） */
